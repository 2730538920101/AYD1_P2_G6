...
function Carta(props) { 
    ...
    const eliminar = () => { 
        alert( props.idW)
        /*
        fetch(`https://localhost:5000/eliminarPeliculaWatchlist/${props.id}`, {
            method: 'DELETE',
            headers: {
    ...
    return ( 
        <Card style={{ width: '20%', margin: '10px' }}>
            ...
            <Card.Body>
                ...
                <Button variant="success" onClick={ver}>VER</Button>
                <Button variant="danger" style={{ marginLeft: '10%' }} onClick={eliminar}>ELIMINAR</Button>
            </Card.Body>
        </Card>
    )
}
